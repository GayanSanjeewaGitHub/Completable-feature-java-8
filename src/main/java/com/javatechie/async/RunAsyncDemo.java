...
public class RunAsyncDemo {
    ...
    public Void saveEmployees(File jsonFile) throws ExecutionException, InterruptedException {
        ObjectMapper mapper = new ObjectMapper(); //ajax is there for json parser
        CompletableFuture<Void> runAsyncFuture = CompletableFuture.runAsync(new Runnable() { //expectoing return void
